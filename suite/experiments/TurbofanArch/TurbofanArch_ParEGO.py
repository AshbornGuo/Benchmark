...
PATH_RESULT = PROJECT_ROOT / "results" / "TurbofanArch" / "SBO_qLogNParEGO"
PATH_RESULT.mkdir(parents=True, exist_ok=True)

LOG_CSV = PATH_RESULT / f"TurbofanArch_qLogNParEGO_seed{seed}.csv"
...
if __name__ == "__main__":
    ...
    train_obj = torch.tensor(train_obj_list, dtype=torch.double)  
    train_cv = torch.tensor(train_cv_list, dtype=torch.double)    
