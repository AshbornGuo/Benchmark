...
PATH_RESULT = PROJECT_ROOT / "results" / "TurbofanArch" / "SMS_EMOA"
PATH_RESULT.mkdir(parents=True, exist_ok=True)

LOG_CSV = PATH_RESULT / f"TurbofanArch_SMSEMOA_seed{seed}.csv"
...
if __name__ == "__main__":
    ...
    pd.DataFrame({"gen_time": gen_time}).to_csv(
        PATH_RESULT / f"TurbofanArch_SMSEMOA_gentime{seed}.csv",
        index=False,
        sep=";",
    )