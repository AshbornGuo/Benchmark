...
PATH_RESULT = PROJECT_ROOT / "results" / "mazda" / "SMS_EMOA"
PATH_RESULT.mkdir(parents=True, exist_ok=True)

LOG_CSV = PATH_RESULT / f"Mazda_SMSEMOA_seed{random_seed}.csv"
...
if __name__ == "__main__":
    ...
    pd.DataFrame({"gen_time": gen_time}).to_csv(
        PATH_RESULT / f"Mazda_SMSEMOA_gentime{random_seed}.csv",
        index=False,
        sep=";",
    )