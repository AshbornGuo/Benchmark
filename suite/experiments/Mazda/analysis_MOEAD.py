...
RESULT_DIR = BASE_DIR / "results" / "mazda" / "MOEAD"

PATH_MOEAD_331 = RESULT_DIR / "Mazda_MOEAD_seed331.csv"
PATH_MOEAD_332 = RESULT_DIR / "Mazda_MOEAD_seed332.csv"
PATH_MOEAD_333 = RESULT_DIR / "Mazda_MOEAD_seed333.csv"
...
# take average
hv_runs = [hv_MOEAD_331, hv_MOEAD_332, hv_MOEAD_333]  
hv_runs = np.array(hv_runs)   # shape: (5, T)
hv_mean = hv_runs.mean(axis=0)
hv_std = hv_runs.std(axis=0)


fea_runs = [fea_MOEAD_331, fea_MOEAD_332, fea_MOEAD_333]  
