...
RESULT_DIR = BASE_DIR / "results" / "mazda" / "SMS_EMOA"

PATH_SMS_EMOA_331 = RESULT_DIR / "Mazda_SMSEMOA_seed331.csv"
PATH_SMS_EMOA_332 = RESULT_DIR / "Mazda_SMSEMOA_seed332.csv"
PATH_SMS_EMOA_333 = RESULT_DIR / "Mazda_SMSEMOA_seed333.csv"
...
# take average
hv_runs = [hv_SMS_EMOA_331, hv_SMS_EMOA_332, hv_SMS_EMOA_333]  
hv_runs = np.array(hv_runs)  
hv_mean = hv_runs.mean(axis=0)
hv_std = hv_runs.std(axis=0)


fea_runs = [fea_SMS_EMOA_331, fea_SMS_EMOA_332, fea_SMS_EMOA_333]  
