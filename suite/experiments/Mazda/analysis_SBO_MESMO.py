...
RESULT_DIR = BASE_DIR / "results" / "mazda" / "MESMO"

PATH_SBO_MESMO_331 = RESULT_DIR / "Mazda_MESMO_seed331.csv"
PATH_SBO_MESMO_332 = RESULT_DIR / "Mazda_MESMO_seed332.csv"
PATH_SBO_MESMO_333 = RESULT_DIR / "Mazda_MESMO_seed333.csv"
...
# take average
hv_runs = [hv_SBO_MESMO_331, hv_SBO_MESMO_332, hv_SBO_MESMO_333] 
hv_runs = np.array(hv_runs)   
hv_mean = hv_runs.mean(axis=0)
hv_std = hv_runs.std(axis=0)


fea_runs = [fea_SBO_MESMO_331, fea_SBO_MESMO_332, fea_SBO_MESMO_333] 
