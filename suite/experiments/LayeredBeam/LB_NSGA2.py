...
RESULT_ROOT = PROJECT_ROOT / "results" / "LayeredBeam" / "NSGA2"
RESULT_ROOT.mkdir(parents=True, exist_ok=True)

LOG_CSV = RESULT_ROOT / f"LayeredBeam_NSGA2_seed{seed}.csv"
...
if __name__ == "__main__":
    ...
    pd.DataFrame({"gen_time": gen_time}).to_csv(
        RESULT_ROOT / f"LayeredBeam_NSGA2_gentime{seed}.csv",
        index=False,
        sep=";",
    )