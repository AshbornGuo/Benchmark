...
hv_runs = [hv_qLogNParEGO_331, hv_qLogNParEGO_332, hv_qLogNParEGO_333]  # 每个是长度 T 的 list
...
Fraw_ParEGO_331 = read_res_raw(PATH_qLogNParEGO_331)


# --- 分别画每个 seed 的分层 Pareto（第0层连线） ---
plot_nd_layers_with_connected_front0(
    Fraw_ParEGO_331,
    title="Pareto_front_ParEGO_331",
    save_path="results/LayeredBeam/qLogNParEGO/Pareto_front_ParEGO_331.png",
