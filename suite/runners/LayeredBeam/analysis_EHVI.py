...
RESULT_DIR = PROJECT_ROOT / "results" / "LayeredBeam" / "qLogNEHVI"



PATH_qLogNEHVI_331 = RESULT_DIR / "LayeredBeam_qLogNEHVI_seed331.csv"
PATH_qLogNEHVI_332 = RESULT_DIR / "LayeredBeam_qLogNEHVI_seed332.csv"
PATH_qLogNEHVI_333 = RESULT_DIR / "LayeredBeam_qLogNEHVI_seed333.csv"
...
Fnor_qLogNEHVI_331 = read_res(PATH_qLogNEHVI_331)
Fnor_qLogNEHVI_332 = read_res(PATH_qLogNEHVI_332)
Fnor_qLogNEHVI_333 = read_res(PATH_qLogNEHVI_333)




# # hypervolume
hv_qLogNEHVI_331 = hv_analysis(Fnor_qLogNEHVI_331, step)
hv_qLogNEHVI_332 = hv_analysis(Fnor_qLogNEHVI_332, step)
hv_qLogNEHVI_333 = hv_analysis(Fnor_qLogNEHVI_333, step)
...
plt.tight_layout()
plt.savefig("results/LayeredBeam/qLogNEHVI/HV_curve.png", dpi=300, bbox_inches="tight")
plt.close()


# # check the hv value
# print("EHVI:", hv_mean[49:60])
# print(hv_mean[-5:])
...
Fraw_EHVI_331 = read_res_raw(PATH_qLogNEHVI_331)


# --- 分别画每个 seed 的分层 Pareto（第0层连线） ---
plot_nd_layers_with_connected_front0(
    Fraw_EHVI_331,
    title="Pareto_front_EHVI_331",
    save_path="results/LayeredBeam/qLogNEHVI/Pareto_front_EHVI_331.png",
