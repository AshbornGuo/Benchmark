...
PATH_RESULT = r"C:/Users/guoji/Desktop/python3_11_test/results/LayeredBeam/NSGA2"
os.makedirs(PATH_RESULT, exist_ok=True)

LOG_CSV = os.path.join(PATH_RESULT, f"LayeredBeam_NSGA2_seed{seed}.csv")
...
if __name__ == "__main__":
    ...
    pd.DataFrame({"gen_time": gen_time}).to_csv(
        os.path.join(PATH_RESULT, f"LayeredBeam_NSGA2_gentime{seed}.csv"),
        index=False,
        sep=";",
    )