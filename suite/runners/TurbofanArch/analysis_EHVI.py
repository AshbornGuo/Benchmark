...
RESULT_DIR = PROJECT_ROOT / "results" / "TurbofanArch" / "SBO_qLogNEHVI"

PATH_SBO_qLogNEHVI_331 = RESULT_DIR / "TurbofanArch_qLogNEHVI_seed331.csv"
PATH_SBO_qLogNEHVI_332 = RESULT_DIR / "TurbofanArch_qLogNEHVI_seed332.csv"
PATH_SBO_qLogNEHVI_333 = RESULT_DIR / "TurbofanArch_qLogNEHVI_seed333.csv"
...
cons_331, Fnor_331, Fraw_331 = read_res(PATH_SBO_qLogNEHVI_331)
cons_332, Fnor_332, Fraw_332 = read_res(PATH_SBO_qLogNEHVI_332)
cons_333, Fnor_333, Fraw_333 = read_res(PATH_SBO_qLogNEHVI_333)
...
for seed, cons, Fraw in plot_info:
    ...
    plot_3d_pareto_with_all_types(
        ...
        F_dom,
        F_infeas,
        title=f"3D Pareto Front - SBO_qLogNEHVI seed{seed}",
        save_path=RESULT_DIR / f"Pareto_front0_3D_alltypes_qLogNEHVI_{seed}.png"
    )
