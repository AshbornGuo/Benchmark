...
RESULT_DIR = PROJECT_ROOT / "results" / "TurbofanArch" / "EGBO"

PATH_EGBO_331 = RESULT_DIR / "TurbofanArch_EGBO_seed331.csv"
PATH_EGBO_332 = RESULT_DIR / "TurbofanArch_EGBO_seed332.csv"
PATH_EGBO_333 = RESULT_DIR / "TurbofanArch_EGBO_seed333.csv"
...
cons_331, Fnor_331, Fraw_331 = read_res(PATH_EGBO_331)
cons_332, Fnor_332, Fraw_332 = read_res(PATH_EGBO_332)
cons_333, Fnor_333, Fraw_333 = read_res(PATH_EGBO_333)
...
for seed, cons, Fraw in plot_info:
    ...
    plot_3d_pareto_with_all_types(
        ...
        F_dom,
        F_infeas,
        title=f"3D Pareto Front - EGBO seed{seed}",
        save_path=RESULT_DIR / f"Pareto_front0_3D_alltypes_EGBO_{seed}.png"
    )
