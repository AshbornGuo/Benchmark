...
PATH_RESULT = r"C:/Users/guoji/Desktop/python3_11_test/results/TurbofanArch/NSGA2"
os.makedirs(PATH_RESULT, exist_ok=True)

LOG_CSV = os.path.join(PATH_RESULT, f"TurbofanArch_NSGA2_seed{seed}.csv")
...
class TurbofanProblem(ElementwiseProblem):
    def __init__(self, log_csv_path, **kwargs):
        ...
        super().__init__(
            ...
            n_ieq_constr=tmp_problem.n_constr,   # 新版 pymoo 推荐这样写
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        # 如果无效，替换成非常差但有限的值，避免 NSGA2 内部报错
        if not is_valid:
...
if __name__ == "__main__":
    ...
    pd.DataFrame({"gen_time": gen_time}).to_csv(
        os.path.join(PATH_RESULT, f"TurbofanArch_NSGA2_gentime{seed}.csv"),
        index=False,
        sep=";",
    )
    ...
    #     })
    #     final_df.to_csv(
    #         os.path.join(PATH_RESULT, f"TurbofanArch_NSGA2_finalPF_seed{seed}.csv"),
    #         index=False,
    #         sep=";"
    #     )