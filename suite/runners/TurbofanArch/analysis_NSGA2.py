...
RESULT_DIR = PROJECT_ROOT / "results" / "TurbofanArch" / "NSGA2"

PATH_NSGA2_331 = RESULT_DIR / "TurbofanArch_NSGA2_seed331.csv"
PATH_NSGA2_332 = RESULT_DIR / "TurbofanArch_NSGA2_seed332.csv"
PATH_NSGA2_333 = RESULT_DIR / "TurbofanArch_NSGA2_seed333.csv"
...
cons_331, Fnor_331, Fraw_331 = read_res(PATH_NSGA2_331)
cons_332, Fnor_332, Fraw_332 = read_res(PATH_NSGA2_332)
cons_333, Fnor_333, Fraw_333 = read_res(PATH_NSGA2_333)
...
for seed, cons, Fraw in plot_info:
    ...
    plot_3d_pareto_with_all_types(
        ...
        F_dom,
        F_infeas,
        title=f"3D Pareto Front - NSGA2 seed{seed}",
        save_path=RESULT_DIR / f"Pareto_front0_3D_alltypes_NSGA2_{seed}.png"
    )
