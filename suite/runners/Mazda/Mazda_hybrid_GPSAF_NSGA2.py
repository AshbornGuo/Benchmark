...
PATH_RESULT   = r"C:/Users/guoji/Desktop/python3_11_test/results/mazda/GPSAF_NSGA2"
LOG_CSV = os.path.join(PATH_RESULT, f"Mazda_GPSAF_NSGA2_seed{random_seed}.csv")
...
base = NSGA2(pop_size=population_size, n_offsprings=population_size)


# 使用默认参数
# algorithm = GPSAF(base)
algorithm = GPSAF(base,
                  alpha=10,
                  beta=50,
                  n_max_doe=100,
