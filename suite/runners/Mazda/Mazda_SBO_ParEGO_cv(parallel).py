...
num_eval = 1500          # total black-box eval budget
...
# -------------------------
# 3) Black-box evaluation (Mazda version, keep LB style)
# -------------------------
...
def eval_one_x(x_np: np.ndarray):
    ...
    # same transform as your serial Mazda code
    f1_hv = f1 - 2.0
    f2_hv = f2 / 74.0
...
# -------------------------
# 7) Main BO loop with qLogNParEGO
# -------------------------
if __name__ == "__main__":
    ...
    while eval_count < num_eval:
        ...
        # build GP models (2 objectives + 1 cv)
        ...
        # back to original space + snap to legal Mazda discrete values
